...
public class VerzekeringsmaatschappijLauncher {
    public static void main(String[] args) {
        ...
        Polis testWA = new WA_Polis("Tom Poes", 100000, LocalDate.parse("2021-09-01"), 1, 4);
        Polis testAP = new AutoPolis("Wammes Waggel", 10000, LocalDate.parse("2021-07-31"), 2, auto2, 8);
